...
are always written into temporary file regardles of this flag. Master playlist files (C<master_pl_name>), if any, with C<file> protocol,
are always written into temporary file regardles of this flag if C<master_pl_publish_rate> value is other than zero.
